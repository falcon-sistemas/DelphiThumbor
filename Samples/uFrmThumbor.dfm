object Form4: TForm4
  ...
  object edtSecretKey: TEdit
    ...
    Height = 21
    TabOrder = 0
    Text = 'mYdVBN25gyqUGD3QRsI9_rl1IxQ'
  end
  object memUrl: TMemo
    Left = 21
    Top = 296
  ...
  object edtUrlServerThumbor: TEdit
    ...
    Height = 21
    TabOrder = 2
    Text = 'https://daninha.tbdc.com.br/'
  end
  object edtPathImage: TEdit
    ...
    TabOrder = 3
    Text = 
      'https://resource.tbdc.com.br/imagem/0336DCBAB05B9D5AD24F4333C765' +
      '8A0E/b8312cf596241b03e135697e4284f8be.jpg'
  end
